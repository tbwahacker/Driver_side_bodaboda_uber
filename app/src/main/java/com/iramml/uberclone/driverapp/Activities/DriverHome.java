...
import com.iramml.uberclone.driverapp.Model.latLong;
...
public class DriverHome extends AppCompatActivity
    ...
    private DatabaseReference drivers, onlineRef, currentUserRef,driver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Motorcylist Home");
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b){
                    ...
                    if(FirebaseDatabase.getInstance() != null){
                        ...
                        driver = FirebaseDatabase.getInstance().getReference(Common.driver_tbl);
                    }
                    else



//                    updateInfo.put("lat", Common.currentLat);
//
//                    updateInfo.put("lng",Common.currentLng);
...
//                        usersRef =  driver.child(FirebaseAuth.getInstance().getCurrentUser().getUid());
//                    Map<String, latLong> users = new HashMap<>();
//                    users.put("latitude", new latLong(Common.currentLat,Common.currentLng));
//                    users.put("longitude", new latLong(Common.currentLat,Common.currentLng));
//                    usersRef.setValue(users);

//                    driver.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(Common.currentLat);
//                    driver.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(Common.currentLng);


                        Toast.makeText(DriverHome.this, "Something went Wrong!!.. please check your internet connection", Toast.LENGTH_LONG).show();
